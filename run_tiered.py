...
def parser_args():
    ...
    parser.add_argument('--dataset', type=str, default='tiered', help='Dataset')
    ...
    parser.add_argument('--wd_rate', type=float, default=0, help='Weight decay rate in Adam optimizer')
    parser.add_argument('--lr', type=float, default=1e-3, help='Learning rate')
    parser.add_argument('--lr_decay', type=int, default=0.1, help='Decaying parameter of learning rate')
    parser.add_argument('--lr_step', type=int, default=30000)
    parser.add_argument("--drop_out", nargs="+", default=[0.2, 0.2, 0.2, 0.2])
